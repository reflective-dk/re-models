...
describe('Test definition loading', function() {
    ...
    it('should load model:metamodel', function() {
        bootstrap.model().should.nested.deep.include({
    ...
    it('should load class:core:object', function() {
        bootstrap.objects(modelId)['class:core:object'].should.nested.deep.include({
    ...
    it('should load class:core:model', function() {
        bootstrap.objects(modelId)['class:core:model'].should.nested.deep.include({
            'registrations[0].validity[0].input.model': { id: modelId },
            'registrations[0].validity[0].input.class': 'class:core:class',
    ...
    it('should load class:core:class', function() {
        bootstrap.objects(modelId)['class:core:class'].should.nested.deep.include({
            'registrations[0].validity[0].input.model': { id: modelId },
            'registrations[0].validity[0].input.class': 'class:core:class',
    ...
    it('should load class:core:schema-validation', function() {
        bootstrap.objects(modelId)['class:core:schema-validation'].should.nested.deep.include({
            'registrations[0].validity[0].input.model': { id: modelId },
            'registrations[0].validity[0].input.class': 'class:core:class',
    ...
    it('should reload definitions on every instantiation', function() {
        bootstrap.objects(modelId)['class:core:class'].extraneous = true;
        bootstrap.objects(modelId)['class:core:class'].should.not.include({
            extraneous: true
        });
    });
});
